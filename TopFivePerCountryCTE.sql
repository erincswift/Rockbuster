/*Query to determine the number of top five customers per country using CTE*/
...
--Create table with total customer counts for each country
all_customer_count (country_id, country, customer_count) as 
(
	Select 
		country.country_id as country_id,
